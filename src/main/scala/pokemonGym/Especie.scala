...
object Especie {
  ...
  def Charizard() = {
    Especie(400, 100, Fuego, Dragon, 60, 60, 60 , 60, SubirDeNivel(10000000), null)
  }
  def Ratata() = {
    Especie(1, 1, Normal, null, 1, 1, 1, 1,Intercambiar(), null)
  }
  def Monkey() = {
	  Especie(25, 6, Pelea, null, 3, 4, 5, 6, SubirDeNivel(10000), null)
  }
  def Gengar() = {
	  Especie(390, 1, Fantasma, null, 45, 45, 50, 60, SubirDeNivel(10000), null)
  }
  def Pikachu() = {
    Especie(390, 1, Electrico, Normal, 45, 45, 50, 60, UsarPiedra(), Raichu())
  }
  def Raichu() = {
    Especie(390, 1, Electrico, null, 45, 45, 50, 60, UsarPiedra(), null)
  }
  def Jigglypuff() = {
